...
def main(args):
    ...
    # simulate forward
    std_out       = traj.simulate(xp,         float(data_pt["tps"]), data_pt["celltype"], data_pt["w"], net, config, int(args.num_sims), int(args.num_cells), num_steps, device, args.tp_subset, args.celltype_subset)

    perturbed_out = traj.simulate(xp_perturb, float(data_pt["tps"]), data_pt["celltype"], data_pt["w"], net, config, int(args.num_sims), int(args.num_cells), num_steps, device, args.tp_subset, args.celltype_subset)
